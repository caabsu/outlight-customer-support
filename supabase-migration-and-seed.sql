...
CREATE TABLE IF NOT EXISTS "OnboardingSection" (
    "id" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "OnboardingSection_slug_key" ON "OnboardingSection"("slug");
CREATE INDEX IF NOT EXISTS "OnboardingSection_category_idx" ON "OnboardingSection"("category");
CREATE INDEX IF NOT EXISTS "OnboardingSection_order_idx" ON "OnboardingSection"("order");
CREATE INDEX IF NOT EXISTS "TrainingVideo_category_idx" ON "TrainingVideo"("category");
CREATE INDEX IF NOT EXISTS "TrainingVideo_order_idx" ON "TrainingVideo"("order");

-- Step 2: Clear Existing Data (Optional - uncomment if you want to reset)
-- =====================================================
-- DELETE FROM "OnboardingSection";
-- DELETE FROM "TrainingVideo";

-- Step 3: Insert Tool SOP Sections
-- =====================================================

INSERT INTO "OnboardingSection" ("id", "title", "slug", "category", "order", "icon", "content", "createdAt", "updatedAt")
VALUES
(
...
(
    gen_random_uuid()::text,
    'Using the Draft AI Tool',
    'draft-ai-tool',
    'tool-sop',
    4,
    '🤖',
    '## How the Draft AI Works
...
(
    ...
    6,
    '📦',
    '## What is the Product Knowledge Base?
...
(
    ...
    9,
    '🔧',
    '## Issue 1: Draft AI Isn''t Working
...
-- Step 4: Insert General SOP Sections
-- =====================================================
...
(
    gen_random_uuid()::text,
    'Handling ''Where Is My Order?'' (WISMO)',
    'wismo-handling',
    'general-sop',
    3,
    '📍',
...
(
    ...
    5,
    '✏️',
    '## Cancel Request (Order is Unfulfilled)
