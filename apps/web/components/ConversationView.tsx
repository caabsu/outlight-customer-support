...
export default function ConversationView() {
  ...
  const {
    ...
    forceSelectConversation, refreshConversations, updateConversationOptimistic, pagination, goToPage,
               ...
               {history.map(h => (
                  ...
                  >
                     ...
                     <div className="flex flex-col gap-1 border-l border-slate-100 pl-3 ml-1">
                        <button
                           onClick={(e) => { e.stopPropagation(); forceSelectConversation(h.id); setShowRelatedModal(false); }}
